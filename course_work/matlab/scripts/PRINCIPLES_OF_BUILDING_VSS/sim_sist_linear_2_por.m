function FIGS = sim_sist_linear_2_por(InitialConditions,PATH)
...
Cellfig_description{1}='СС замкнутой системы 2 порядка с пропорционально-дифференциальным регулятором.';
